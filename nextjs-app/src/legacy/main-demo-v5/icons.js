...
export const ICON = {
  ...
  bus: (s = 16) =>
    svg(s, `<path d="M8 6v6"/><path d="M16 6v6"/><path d="M2 12h20"/><path d="M18 18h1a2 2 0 0 0 2-2V7a4 4 0 0 0-4-4H7a4 4 0 0 0-4 4v9a2 2 0 0 0 2 2h1"/><path d="M7 18h10"/><circle cx="7" cy="18" r="2"/><circle cx="17" cy="18" r="2"/>`),
  train: (s = 16) =>
    svg(s, `<rect x="4" y="3" width="16" height="13" rx="2"/><path d="M8 16l-2 4"/><path d="M16 16l2 4"/><path d="M8 11h.01"/><path d="M16 11h.01"/><path d="M8 7h8"/>`),
  car: (s = 16) =>
  ...
  luggage: (s = 16) =>
    svg(s, `<path d="M10 6V5a2 2 0 0 1 4 0v1"/><rect x="6" y="6" width="12" height="14" rx="2"/><path d="M8 20v2"/><path d="M16 20v2"/><path d="M10 11h4"/>`),
  hotel: (s = 16) =>
    svg(s, `<path d="M3 21h18"/><path d="M5 21V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v16"/><path d="M9 21v-6h6v6"/><path d="M8 7h.01M12 7h.01M16 7h.01M8 11h.01M12 11h.01M16 11h.01"/>`),
  ...
  // family / transit assistant
  baby: (s = 18) =>
    svg(s, `<circle cx="12" cy="12" r="10"/><path d="M9 12h.01M15 12h.01"/><path d="M9.5 16a3 3 0 0 0 5 0"/>`),
  stroller: (s = 18) =>
    svg(s, `<path d="M3 5h2l3 8h10"/><path d="M18 13a5 5 0 0 0-10 0"/><circle cx="9" cy="19" r="2"/><circle cx="17" cy="19" r="2"/>`),
  play: (s = 18) =>
    svg(s, `<rect x="3" y="3" width="18" height="18" rx="3"/><path d="M10 8.5v7l5.5-3.5z"/>`),
  calm: (s = 18) =>
    svg(s, `<path d="M3 12c2-4 5-6 9-6s7 2 9 6c-2 4-5 6-9 6s-7-2-9-6z"/><circle cx="12" cy="12" r="2"/>`),
  info: (s = 16) =>
    svg(s, `<circle cx="12" cy="12" r="10"/><path d="M12 16v-4M12 8h.01"/>`),
  clock: (s = 16) =>
    svg(s, `<circle cx="12" cy="12" r="10"/><path d="M12 6v6l4 2"/>`),
  ticket: (s = 16) =>
    svg(s, `<path d="M2 9a3 3 0 0 1 0 6v2a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-2a3 3 0 0 1 0-6V7a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2z"/><path d="M13 5v14"/>`),
  alert: (s = 16) =>
    svg(s, `<path d="M10.3 3.86 1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/><path d="M12 9v4M12 17h.01"/>`),
