...
const ASSET_BASE = "../../public/assets/main-demo-v5/airport";
...
export const hkgProfiles = {
  family: {
    ...
    routeLabel: "亲子路线",
    map: {
      base: `${ASSET_BASE}/family/overview.png?v=20260506-2`,
      overview: `${ASSET_BASE}/family/overview.png?v=20260506-2`,
      alt: "香港机场亲子路书总览",
    },
  ...
  business: {
    ...
    routeLabel: "商务路线",
    map: {
      base: `${BUSINESS_ASSET_BASE}/overview.png?v=20260506-2`,
      overview: `${BUSINESS_ASSET_BASE}/overview.png?v=20260506-2`,
      alt: "香港机场商务路书总览",
    },
  ...
  transfer: {
    ...
    routeLabel: "中转路线",
    map: {
      base: `${TRANSFER_ASSET_BASE}/overview.png?v=20260506-2`,
      overview: `${TRANSFER_ASSET_BASE}/overview.png?v=20260506-2`,
      alt: "香港机场中转路书总览",
    },
